    ...
    public void handleKeyDown(KeyEvent event, int stream) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_DOWN:
                 ...
                 */
                int direction;
                boolean swapKeys = Settings.System.getInt(mContext.getContentResolver(), Settings.System.SWAP_VOLUME_KEYS_BY_ROTATE, 0) == 1;
                int rotation = mWindowManager.getDefaultDisplay().getRotation();

                if (swapKeys && (rotation == Surface.ROTATION_90 || rotation == Surface.ROTATION_180)) {
                    direction = keyCode == KeyEvent.KEYCODE_VOLUME_UP ? ADJUST_LOWER : ADJUST_RAISE;
                } else {
                    direction = keyCode == KeyEvent.KEYCODE_VOLUME_UP ? ADJUST_RAISE : ADJUST_LOWER;
                }
